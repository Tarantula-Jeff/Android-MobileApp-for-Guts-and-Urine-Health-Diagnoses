...
public class MainActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){
        try {
            ...
            SampleHistoryRepository.save(this, "Stool", classes[maxPos], historyImage);
            ResultHistoryRepository.save(this, "Stool", classes[maxPos]);

            // Releases model resources if no longer used.
String resultClass = classes[maxPos];
            boolean urgentResult = resultClass.equals("BlackTarry") || resultClass.equals("Redpoop") || resultClass.equals("Mucus") || resultClass.equals("PENCILorFLAT") || resultClass.equals("Greenpoop");
    ...
    public String t1diagnoses(){
        String t1="                                                         "+
                "Marbles Appearance in nature:   Hard and separate little lumps that look like nuts and are hard to pass. Indicates: These little pellets typically mean youÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢re constipated. It shouldnÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢t happen frequently\n" +
                "Remedy\n" +
        ...
        String t2="                                                         "+
                "Caterpillar Appearance:   Log-shaped but lumpy in nature. Indicates: Here we have another sign of constipation that, again, shouldnÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢t happen frequentlyThis stool also can be a sign that youÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢re constipated.\n" +
                "Remedy \n" +
        ...
        String t3="                                                         "+
                "Hot dog Appearance:   Log-shaped with some cracks on the surface. Indicates: This is the gold standard of poop, especially if itÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢s somewhat soft and easy to pass out." +
                " Your guts are healthy. Keep up with your healthy eating.";
        return t3;
    } public String t4diagnoses(){
        String t4="                                                         "+
                "Snake Appearance:   Smooth and snake-like. " +
                "Indicates: Hurry this is a normal poop that should happen every 1ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ3 days and no need to worry about it";
        return t4;
        ...
        String t5="                                                         "+
                ...
                "Indicates: This type of poop means youÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢re lacking fiber\n" +
                "Remedy\n" +
        ...
        String t6="                                                         "+
                ...
                " but you also need to replace the minerals youÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢re losing (called electrolytes). Fruit juices and soup can help.\n";
        return t6;
    } public String t7diagnoses(){
        String t7="                                                         "+
                "Watery Appearance:   Completely watery with no solid pieces. " +
                "Indicates: In other words, youÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ve got the runs or diarrhea. " +
                "This means your stool moved through your bowels very quickly and didnÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢t form into a healthy poop.This could also means you have an inflammation in your digestive system.\n" +
                "Remedy\n" +
        ...
        String fp="                                                         "+
                ...
                "D. Feeling like you arenÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢t fully emptying your stool every time\n" +
                "E. High fever\n" +
                "F. Stomach  pain or cramping\n";
        return fp;
    } public String gpdiagnoses(){
        String gp="                                                         "+
                "Green poop:   Well, It may be because you ate a lot of green vegetables (which is good) or too much green food coloring (not so good). ). It also may mean that your food is moving through your system too quickly -- think diarrhea -- and the green in your bile doesnÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢t have time to break down.\n" +
                ...
                "Remedy\n" +
                "If the color doesnÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢t change, see a doctor. \n";
        return gp;
        ...
        String rp="                                                         "+
                ...
                "Sometimes itÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢s blood from your rectum, too, from a scratch or a hemorrhoid. " +
    ...
    public String mdiagnoses(){
        String m="                                                         "+
                ...
                "1.CrohnÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢s disease: This affects the GI tract accompanied with symptoms including diarrhea or fatigue\n" +
